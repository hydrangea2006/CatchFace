...
#   # L/R 结尾代表左右。
    ...
    def get_arkit_blendshapes_response(self, raw_face_landmarks):
        ...
        arkit_blendshapes = {
            ...
            "eyeLookDownLeft":  float(raw_bs.get("eyeLookDownLeft", 0.0)),
            "eyeLookDownRight": float(raw_bs.get("eyeLookDownRight", 0.0)),
            ...
            "jawForward":       float(raw_bs.get("jawForward", 0.0)),
            ...
            "mouthLeft":        float(raw_bs.get("mouthLeft", 0.0)),
            "mouthRight":       float(raw_bs.get("mouthRight", 0.0)),
            ...
            "mouthStretchLeft": float(raw_bs.get("mouthStretchLeft", mouth_stretch_val)),
            "mouthStretchRight":float(raw_bs.get("mouthStretchRight", mouth_stretch_val)),
            "mouthDimpleLeft":  float(raw_bs.get("mouthDimpleLeft", 0.0)),
            "mouthDimpleRight": float(raw_bs.get("mouthDimpleRight", 0.0)),
            "mouthPressLeft":   float(raw_bs.get("mouthPressLeft", 0.0)),
            "mouthPressRight":  float(raw_bs.get("mouthPressRight", 0.0)),
            "mouthRollLower":   float(raw_bs.get("mouthRollLower", 0.0)),
            "mouthRollUpper":   float(raw_bs.get("mouthRollUpper", 0.0)),
            "mouthShrugLower":  float(raw_bs.get("mouthShrugLower", 0.0)),
            "mouthShrugUpper":  float(raw_bs.get("mouthShrugUpper", 0.0)),
            "mouthUpperUpLeft": float(raw_bs.get("mouthUpperUpLeft", 0.0)),
            "mouthUpperUpRight":float(raw_bs.get("mouthUpperUpRight", 0.0)),
            "mouthLowerDownLeft": float(raw_bs.get("mouthLowerDownLeft", 0.0)),
            "mouthLowerDownRight":float(raw_bs.get("mouthLowerDownRight", 0.0)),
            "cheekPuff":        float(raw_bs.get("cheekPuff", 0.0)),
            ...
            "tongueOut":        float(raw_bs.get("tongueOut", 0.0))
        }
